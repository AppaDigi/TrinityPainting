        ...
        <div className="relative min-h-screen w-full flex flex-col font-sans overflow-x-hidden bg-background">
            ...
            <main className="flex-grow pt-24 md:pt-32 pb-24 relative z-10">
                ...
                <section className="container-wide mb-24">
                    <div className="bg-primary rounded-3xl lg:rounded-[3rem] overflow-hidden relative border border-white/5 shadow-2xl min-h-[500px] flex flex-col justify-center">
                        <div className="absolute inset-0">
                            <Image
                                src="/team photos/Team Page Hero.png"
                        ...
                        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-gold/20 rounded-full blur-[120px] translate-x-1/3 -translate-y-1/3" />

                        <div className="p-8 md:p-12 lg:p-24 relative z-10 max-w-4xl">
                            <span className="text-gold font-black text-xs uppercase tracking-[0.3em] mb-6 block">Meet the Trinity Crew</span>
                            <h1 className="text-white mb-8 leading-[1.1] text-5xl md:text-6xl lg:text-7xl">
